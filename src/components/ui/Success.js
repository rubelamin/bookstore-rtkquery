...
export default function Success({ message }) {
  return (
    <div class="flex rightAlert justify-center items-center m-1 font-medium py-1 px-2 bg-white rounded-md text-green-700 bg-green-100 border border-green-300 ">
      <div slot="avatar">
        <svg
